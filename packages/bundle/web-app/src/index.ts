...
// Type-only: pulls the `settings` Context merge for the skin namespace registration below.
import type {} from '@deepseek-ai/dsh-settings'
// Value import: the branded-namespace constructor for the skin registration.
...
export function apply(ctx: Context, config: Config): void {
  // Register the durable `skin` settings namespace. The browser-half skin
  // toggle (@deepseek-ai/dsh-client-ui-skin-toggle) reads and hot-reloads it,
  // so Blue Fantasy / default switching persists without a restart.
