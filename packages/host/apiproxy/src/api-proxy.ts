...
const WEB_SETTINGS_NAMESPACES = [
  ...
  // `skin` is owned by the WebUI Blue Fantasy toggle (@deepseek-ai/dsh-client-ui-skin-toggle):
  // the choice lives in a durable settings namespace so the harness applies it
  // without a restart and persists it across restarts.
  'skin',
] as const
